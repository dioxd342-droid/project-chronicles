...
public final class ChroniclesPlugin extends JavaPlugin {
    ...
    @Override public void onEnable() {
        ...
        experienceService = new ExperienceService(this); economyService = new EconomyService(this);
        questService = new QuestService(this); progressQuestService = new ProgressQuestService(this);
        factionService = new FactionService(this); npcService = new NpcService(this);
    ...
    @Override public void onDisable() {
        ...
        if (cosmeticPetService != null) cosmeticPetService.shutdown();
    ...
    public ProgressQuestService getProgressQuestService() { return progressQuestService; }
    ...
    public CosmeticPetService getCosmeticPetService() { return cosmeticPetService; }
}
