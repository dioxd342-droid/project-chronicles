...
public final class ChroniclesPlugin extends JavaPlugin {
    ...
    @Override public void onEnable() {
        ...
        experienceService = new ExperienceService(this); economyService = new EconomyService(this); questService = new QuestService(this);
        factionService = new FactionService(this); npcService = new NpcService(this); worldEventService = new WorldEventService(this);
        decisionService = new DecisionService(this); donationService = new DonationService(this); cosmeticService = new CosmeticService(this);
    ...
    public DecisionService getDecisionService() { return decisionService; } public DonationService getDonationService() { return donationService; }
