...
public final class ChroniclesPlugin extends JavaPlugin {
    private PlayerManager playerManager; private ExperienceService experienceService; private EconomyService economyService;
    private QuestService questService; private FactionService factionService; private NpcService npcService;
    ...
    @Override public void onEnable() {
        saveDefaultConfig(); playerManager = new PlayerManager(this); playerManager.initialize(); experienceService = new ExperienceService(this);
        economyService = new EconomyService(this); questService = new QuestService(this); factionService = new FactionService(this); npcService = new NpcService(this);
        ...
        getServer().getPluginManager().registerEvents(new PlayerActivityListener(this), this); getServer().getPluginManager().registerEvents(new NpcInteractionListener(this, npcService), this);
    ...
    public EconomyService getEconomyService() { return economyService; } public QuestService getQuestService() { return questService; } public FactionService getFactionService() { return factionService; }
    public WorldEventService getWorldEventService() { return worldEventService; } public DecisionService getDecisionService() { return decisionService; } public DonationService getDonationService() { return donationService; }
    public CosmeticService getCosmeticService() { return cosmeticService; } public CosmeticPetService getCosmeticPetService() { return cosmeticPetService; }
}
